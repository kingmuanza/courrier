                                ...
                                buttons: {
                                    Oui: {
                                        ...
                                        action: function () {
                                            ...
                                            window.open("tache#/procedures_encours?t=" + tempsEnMs);
                                            window.close();
                                        }
                                    },
                                    Annuler: {
                                ...
                                <div class="step-content">
                                    <div class="ribbed-grayLighter padding20" style="padding-right: 20px; border-bottom: 1px solid #1ba1e2;">
                                        <div class="row cells6">
                                            <span class="fg-blue" onclick="window.location.href='tache#/procedures'" style="cursor: pointer;">Procédures</span>
                                            <h1 id="titre_liste">Procédures en cours </h1>
                                        ...
                                        <div class="row cells6">
                                            <table id="example_table" class="dataTable border bordered" style="margin-bottom: 10px;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <c:forEach items="${procedures}" var="tp">
                                                        <tr>
                                                            <td><a href="tache#/procedures_encours/${tp.idprocedureEffective}">${tp.ref}</a></td>
                                                            <td><a href="tache#/procedures/">${tp.procedures.nom}</a></td>
                                                            <fmt:setLocale value="fr" />
                                                            <fmt:formatDate value="${tp.dateDebut}" type="date" dateStyle="long" var="dateDebut" />
                                                            <td>${dateDebut}</td>
                                                            <td>${tp.statut}</td>
                                                        </tr>
                                                    </c:forEach>
