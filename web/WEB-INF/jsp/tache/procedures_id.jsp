            ...
            <div class="row cells12" style="height: 100%">
                ...
                <div class="cell colspan8" style="height: 100%; padding-top: 40px;">
                                ...
                                <div class="step-content">
                                    <div class="ribbed-grayLighter padding20" style="padding-right: 20px; border-bottom: 1px solid #1ba1e2;">
                                        <div class="row cells6">
                                            <span class="fg-blue" onclick="window.location.href='tache#/procedures'" style="cursor: pointer;">Procédure</span>
                                            <span class="fg-blue place-right mif-play mif-4x" onclick="terminer(${procedure.idprocedures});" style="cursor: pointer;"></span>
                                            <h1 id="titre_liste">${procedure.nom}</h1>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row cells6">
                                            <table id="example_table" class="dataTable border bordered" style="margin-bottom: 10px;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <c:forEach items="${procedure.tacheProcedures}" var="tp">
                                                        <tr>
                                                            <td>${tp.ordre}</td>
                                                            <td><a href="tache#/procedures/">${tp.libelle}</a></td>
                                                            <td>
                                                                ${tp.employe.noms} ${tp.employe.prenoms}<br>
                                                                <small>${tp.employe.poste.libelle}</small>
                                                            </td>
                                                            <td>${tp.dureeEnJour} jour(s)</td>
                    ...
                    <div class="row" style="padding-top: 10px;">
                        <button class="image-button bg-blue fg-white opacity" onclick="showDialog('#dialog2')">
                            Démarrer la procédure
                            <span class="icon mif-play bg-lightGreen fg-white"></span>
                        </button>
                    </div>
                </div>
