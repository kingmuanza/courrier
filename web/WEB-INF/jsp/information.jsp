    ...
    <head>
        ...
        <script>
            ...
            app.config(function ($routeProvider) {
                $routeProvider
                        .when('/', {templateUrl: 'TousInformationsServlet'})

                        .when('/tous', {templateUrl: 'TousInformationsServlet'})
                        .when('/tous/:id', {templateUrl: function (params) {
                                return 'TousInformationsServlet?id=' + params.id;
                            }})
                        .when('/mes', {templateUrl: 'MesInfosServlet'})
                        .when('/mes/:id', {templateUrl: function (params) {
                                return 'MesInfosServlet?id=' + params.id;
                            }})
    ...
    <body class="metro " ng-app="workspace">
        ...
        <div class="keama_haut">
            <div class="fg-white keama_haut_texte">
                ${entreprise.nom}
                <h1 class="keama_h1 fg-blue">INFORMATIONS <sup><span id="spinner" class="mif-spinner mif-ani-spin fg-white"></span></sup></h1>
        ...
        <div class=" ">
            <div id="menu"  class="app-bar navy" data-role="appbar">
                ...
                <ul class="app-bar-menu">
                    ...
                    <li><a href="#tous">Mes infos</a></li>
                    <li><a href="#mes">Tous</a></li>
                </ul>
                ...
                <div class="cell colspan2">
                    <div class="row cells12">
                        <div class="cell colspan9">
                            <h1 class="fg-white">Nouvelle information</h1>
                            <p class="fg-white" style="padding-bottom: 20px;">
                                Vous pouvez partager une information à vos collaborateurs.
                            </p>
                            <form method="post" action="CreationInformationServlet" class="grid condensed">
                                <div class="row cells2">
                                    <div class="cell colspan2">
                                        <label class="fg-white">Titre ou référence</label>
                                ...
                                <div class="row cells">
                                    <div class="cell" style="padding-right: 8px;">
                                        <label class="fg-white">Personnes à informer</label>
