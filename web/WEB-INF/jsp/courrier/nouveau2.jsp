...
<html>
    ...
    <body>
        <div class="grid condensed" style="height: 100%; margin-top: -0px">
            <div class="row cells6" style="height: 100%; background-color: #fff;">
                <div class="cell colspan3 padding10" id="cell-sidebar2" style="background-color: #fff; min-height: 90vh; padding-left: 30px;">
                    <h3 id="titre_liste" style="margin-top:0px; padding-left: 10px;">
                        ${empty courrier ? "Nouveau c": "C"}ourrier entrant 
                        ${empty courrier ? "": ":"} ${empty courrier ? "": courrier.ref}
                    </h3>
                    <c:forEach items="${courrier.courrierFichiers}" var="cf" varStatus="loop">
                        ...
                        <script>
                            ...
                            ctx${loop.index}.canvas.width = window.innerWidth / 2 - 75;
                            var largeur${loop.index} = ctx${loop.index}.canvas.width;
                            ctx${loop.index}.canvas.height = (window.innerWidth / 2 - 75) * 1.5;
...
//                            ctx${loop.index}.drawImage(qrcode${loop.index}, 10, 10, 100, 100);
                            ...
                            if (i && j) {
                                $.post(
                                        "NouveauCourrierServlet2",
                                        {
                                            ...
                                            typeCourrier: $("select[name=nature] option:selected").attr("idtypeCourrier"),
                                    ...
                                    if ($("#nom_procedure").html() == "Aucune procédure") {
                                        window.open("/keamaworkspace/courrier#/prets?time=" + tempsEnMs);
                                        window.close();
                                    } else {
                                        window.open("/keamaworkspace/courrier#/suivi/" + $("input[name=id]").val());
                                        window.close();
                                    }
                                });
                                ;
                ...
                <div class="cell colspan3" style="height: 100%; background-color: rgb(255, 200, 5); padding: 0px; padding-left: 0px;">
                    ...
                    <div class="row cells6">
                        ...
                        <div class="tabcontrol" data-role="tabcontrol">
                            <ul class="tabs">
                                <li>
                                    <a href="#one">Informations </a>
                                </li>
                                <c:if test="${!empty courrier}">
                                    <li>
                                        <a href="#two">Fichiers</a>
                                    </li>
                                </c:if>
                            </ul>
                            <div class="frames">
                                    ...
                                    <div class="grid condensed">
                                        <div class="row cells9">
                                            ...
                                            <div class="cell colspan3" style="padding-right: 10px;">
                                                ...
                                                <div class="input-control text full-size ">
                                                    <select name="nature">
                                                        <c:forEach items="${courrierTypes}" var="ct">
                                                            <option  ${courrier.nature==ct.nom ? "selected":""} idtypeCourrier="${ct.idcourrierType}" value="${ct.nom}" procedure="${ct.courrierProcedures.iterator().hasNext() ? ct.courrierProcedures.iterator().next().nom : "Aucune procédure"}">
                                                                ${ct.nom}
                                                            </option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                                <small><i id="nom_procedure" style="color: #fafafa">Nom de la procédure</i></small>
                                                <script>
                                                    $("select[name=nature]").ready(function () {
                                                        var nom_procedure = $("select[name=nature] option:selected").attr("procedure");
                                                        var idtypecourrier = $("select[name=nature] option:selected").attr("idtypeCourrier");
                                                        $("#nom_procedure").html(nom_procedure);
                                                    });
                                        ...
                                        <div class="row cells6">
                                            <div class="cell colspan6">
                                                ...
                                                <c:if test="${!empty courrier}">
                                                    <a onclick="terminer(${courrier.idcourrier});" style="cursor : pointer;" class="button bg-green fg-white">Terminé</a>
                                                </c:if>
                                                <c:if test="${!empty courrier}">
                                                    <a onclick="supprimer(${courrier.idcourrier});" style="cursor : pointer; background-color: orange" class="button fg-white">Supprimer</a>
                                                </c:if>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div data-role="dialog, draggable" id="dialogCorrespondant" class="grid padding20 ribbed-grayLighter" data-close-button="true" data-width="600">
            <div class="row cells">
                <div class="cell" style="height: 100%">
                    <h3>Correspondant</h3>
                    <div>
        ...
        <div data-role="dialog, draggable" id="dialogEntreprise" class="grid padding20 ribbed-grayLighter" data-close-button="true" data-width="600">
            <div class="row cells">
                <div class="cell" style="height: 100%">
                    <h3>Entreprise</h3>
                    <div>
