    ...
    <body>
        <div id="keama_back" class="grid" style="height: 100%; margin-top: -0px; background-color: #fafafa">
            <div class="row cells12" style="height: 100%">
                ...
                <div class="cell colspan9" style="height: 100%">
                    <div class="row cells6">
                        <h3 id="titre_liste">Liste des courriers ignorés</h3>
                    </div>
                    <div class="row cells6">
                            ...
                            <tbody>
                                <c:forEach items="${courriers}" var="c">
                                    <tr>
                                        ...
                                        <td>${c.expediteur}</td>
                                        <td>${c.objet}</td>
                                        <td>${c.structure.sigle}</td>
                                        <td>${c.statut}</td>
                                        <td onclick="showDialog('#dialog')" style="cursor : pointer ;">Cotation</td>
                                    </tr>
                                </c:forEach>
