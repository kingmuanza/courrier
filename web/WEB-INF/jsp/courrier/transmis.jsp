            ...
            <div class="row cells12" style="height: 100%">
                ...
                <div class="cell colspan9" style="height: 100%; padding-right: 20px;">
                    <div class="row cells6">
                        <h3 id="titre_liste">Liste des courriers transmis</h3>
                        ...
                        <table id="example_table" class="dataTable border bordered" style="margin-bottom: 10px;">
                            <thead>
                                <tr>
                                    ...
                                    <th>Expéditeur/Objet</th>

                                    <th style="width: 50%">Dernière Transmission</th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                <c:forEach items="${courriers}" var="c">
                                    <tr>
                                        ...
                                        <fmt:formatDate value="${c.dateEmission}" type="date" dateStyle="long" var="dateEmission" />

                                        <td>
                                            <a href="courrier#/suivi/${c.idcourrier}">
                                                <b>${c.ref.length()>22 ? c.ref.substring(6,22): c.ref}</b>
                                            </a>
                                            <div>${dateEmission}</div>
                                        </td>
                                        ...
                                        <td> 
                                            <ul>
                                                <c:forEach items="${c.courrierResponsables}" var="cr">
                                                    <li>
                                                    ${cr.employe.noms} ${cr.employe.prenoms} 
                                                    <fmt:formatDate value="${cr.dateRecuperation}" type="date" dateStyle="long" var="dateRecuperation" />
                                                    <fmt:formatDate value="${cr.dateRecuperation}" type="time" timeStyle="short" var="heureRecuperation" />
                                                    <small>le ${dateRecuperation} à ${heureRecuperation}</small><br>
                                                    </li>
                                                </c:forEach>
                                            </ul>
                                        </td>
