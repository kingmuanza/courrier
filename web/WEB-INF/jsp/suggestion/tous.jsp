            ...
            <div class="row cells12" style="height: 100%">
                <div class="cell colspan3" id="cell-sidebar" style="background-image: url('img/keama_background.png'); height: 100%;">
                    ...
                    <ul class="sidebar darcula" style="height: 260px; background-image: url('img/keama_background.png');">
                        <c:forEach items="${suggestions}" var="c">
                            <li class=""><a href="#/id/${c.idsuggestion}">
                                    <fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${c.dateEmission}" var="dateDebut"/>
                                    <span class="mif-bubbles icon"></span>
                                    <span class="title">${c.titre}</span>
                                    <span class="counter">${c.employe.noms} ${c.employe.prenoms} : ${dateDebut}</span>
                                </a>
                            </li>
                        </c:forEach>
                    </ul>
                ...
                <div class="cell colspan7" style="height: 100%">
                    <div class="row cells6">
                        <h1 id="titre_liste">Toutes les suggestions<span class="icon mif-folder-open fg-blue place-right" style="cursor: pointer;" onclick="window.location.href = 'information#/tous/light'"></span></h1>
                        <hr>
                    </div>
                    <div class="row cells6">
                            ...
                            <tbody>
                                <c:forEach items="${suggestions}" var="c">
                                    <tr>
                                        ...
                                        <td><a href="suggestion#/id/${c.idsuggestion}">${c.titre}</a></td>
                                        <td>${c.contenu}</td>
                                    </tr>
                                </c:forEach>
