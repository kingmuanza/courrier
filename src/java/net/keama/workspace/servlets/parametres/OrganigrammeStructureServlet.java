...
@WebServlet(name="OrganigrammeStructureServlet", urlPatterns={"/organigrammeStructure"})
public class OrganigrammeStructureServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (id != null && !id.isEmpty()) {
            ...
            request.setAttribute("entreprise", entrepriseDAO.get(1));
        }
        this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/parametres/organigrammeStructure.jsp").forward( request, response );
    } 
    ...
    throws ServletException, IOException {
        ...
        response.sendRedirect("OrganigrammeStructureServlet");
    }
