...
@WebServlet(name="CourrierServlet", urlPatterns={"/courrier"})
public class CourrierServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (utilisateur != null) {
            ...
            this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/courrier.jsp").forward(request, response);
        }else{
