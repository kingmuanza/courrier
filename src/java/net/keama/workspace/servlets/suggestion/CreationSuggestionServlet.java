...
@WebServlet(name="CreationSuggestionServlet", urlPatterns={"/CreationSuggestionServlet"})
public class CreationSuggestionServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/CreationSuggestionServlet.jsp").forward( request, response );
    } 
    ...
    throws ServletException, IOException {
        ...
        if (action!=null && !action.isEmpty() && action.equals("supprimer")) {
            ...
            if(id!=null && !id.isEmpty()){
                ...
                suggestion.setContenu(contenu);
                suggestion.setDateEmission(new Date());
                suggestion.setEmploye(employe);
                suggestion.setTitre(titre);
                if(suggestionDAO.ajouter(suggestion)){
        ...
        response.sendRedirect("suggestion#/tous");
    }
