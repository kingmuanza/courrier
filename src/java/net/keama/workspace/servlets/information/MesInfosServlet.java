...
@WebServlet(name = "MesInfosServlet", urlPatterns = {"/MesInfosServlet"})
public class MesInfosServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for (InformationGenerale ig : informations) {
            if (ig.getEmploye().getIdemploye() == utilisateur.getEmploye().getIdemploye()) {
        ...
        if (id != null && !id.isEmpty()) {
            if (!informations.isEmpty()) {
                this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/information/mes_infos_light.jsp").forward(request, response);
            } else {
                this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/information/mes_infos.jsp").forward(request, response);
            }
        } else {
            this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/information/mes_infos.jsp").forward(request, response);
        }
