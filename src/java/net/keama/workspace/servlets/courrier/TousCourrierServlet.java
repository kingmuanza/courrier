...
@WebServlet(name = "TousCourrierServlet", urlPatterns = {"/tousCourrier"})
public class TousCourrierServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/courrier/tous.jsp").forward(request, response);
    }
