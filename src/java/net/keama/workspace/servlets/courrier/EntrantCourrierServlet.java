...
@WebServlet(name="EntrantCourrierServlet", urlPatterns={"/EntrantCourrierServlet"})
public class EntrantCourrierServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/courrier/entrants.jsp").forward(request, response);
    }
