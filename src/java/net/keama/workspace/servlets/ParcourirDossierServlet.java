...
@WebServlet(name="ParcourirDossierServlet", urlPatterns={"/ParcourirDossierServlet"})
public class ParcourirDossierServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        response.sendRedirect("ParcourirDossierServlet");
    }
