...
@WebServlet(name="SalarieServlet", urlPatterns={"/SalarieServlet"})
public class SalarieServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/SalarieServlet.jsp").forward( request, response );
    } 
    ...
    throws ServletException, IOException {
        ...
        response.sendRedirect("SalarieServlet");
    }
