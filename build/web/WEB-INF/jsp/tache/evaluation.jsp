            ...
            <div class="row cells6" style="height: 100%">
                ...
                <div class="cell colspan4" style="height: 100%">
                    <div class="row cells6">
                        <h1 id="titre_liste">Evaluation</h1>
                        <small>Actuellement dans l'entreprise</small>
                        <hr class="bg-blue">
                    </div>
                    <div class="row cells6">
                        <table id="example_table" class="dataTable border bordered" style="margin-bottom: 10px;">
                            ...
                            <tbody>
                                <c:forEach items="${employes}" var="t">
                                    <tr>
                                        <td>
                                            ${t.noms} ${t.prenoms}<br>
                                            <small>${t.poste.libelle}</small>
                                        </td>
                                        <td>
                                            <c:forEach items="${t.tachesForIdemploye}" var="tfi">
                                                ${tfi.libelle}<br>
                                            </c:forEach>
                                        </td>
                                        <td>
                                            <c:forEach items="${t.tachesForIdemploye}" var="tfi">
                                                ...
                                                <fmt:formatDate value="${tfi.dateFin}" type="date" dateStyle="long" var="now2" />
                                                ${now2}<br>
                                            </c:forEach>
                                        </td>
                                        <td>
