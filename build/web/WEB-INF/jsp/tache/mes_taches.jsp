            ...
            <div class="row cells12" style="height: 100%">
                ...
                <div class="cell colspan7" style="height: 100%">
                    <div class="row cells7">
                        <h1 id="titre_liste">Mes tâches<span class="icon mif-menu fg-blue place-right" style="cursor: pointer;" onclick="window.location.href = 'tache#/mes/light'"></span></h1>
                        <hr class="bg-blue">
                    </div>
                            ...
                            <tbody>
                                <c:forEach items="${taches}" var="t">
                                    <tr>
                                        ...
                                        <td>${dateFin}</td>
                                        <td><a href="tache#/id/${t.idtache}">${t.libelle}</a></td>
