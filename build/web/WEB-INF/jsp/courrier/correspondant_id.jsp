...
<html>
    ...
    <body>
            ...
            <div class="row cells12" style="height: 100%">
                <div class="cell colspan3" id="cell-sidebar" >
                    ...
                    <ul class="sidebar" style="overflow-x:hidden; padding-left: 0px; height: 60vh; overflow-y: auto; background-color: orange;">
                        <c:forEach items="${courriers}" var="c" end="10">
                            <li class="li_muanza">
                ...
                <div class="cell colspan9" style="height: 100%; padding-right: 20px;">
                    <div class="row cells6">
                        <h3 id="titre_liste">Historique : ${entreprise.nom}</h3>
                            ...
                            <tbody>
                                <c:forEach items="${courriers}" var="c">
                                    <tr>
                                        ...
                                        <fmt:formatDate value="${c.dateEmission}" pattern="yyyy.MM.dd" var="dateEmission" />
                                        <fmt:formatDate value="${c.dateEmission}" type="date" dateStyle="long" var="now2" />
                                        <td><a href="courrier#/suivi/${c.idcourrier}">${c.ref}</a></td>
                                        <td><span style="display:none;">${dateEmission}</span> ${now2}</td>
                                        <td>${c.expediteur}</td>
                                        <td>${c.objet}</td>
                                        <td>${c.statut}</td>
                                    </tr>
        ...
        <div data-role="dialog" id="message" class="grid padding20 ribbed-grayLighter" data-close-button="true" data-width="600" >
            <h1>Message</h1>
            <p style="padding-bottom: 40px;">
                Choisissez le destinataire du courrier
            </p>
