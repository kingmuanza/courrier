    ...
    <body>
        <div id="keama_back" class="grid" style="height: 100%; margin-top: -0px">
            <div class="row cells12" style="height: 100%">
                <div class="cell colspan2" id="cell-sidebar" >
                    ...
                    <ul class="sidebar" style="overflow-x:hidden; padding-left: 0px; height: 60vh; overflow-y: auto; background-color: orange;">
                        <c:forEach items="${procedures}" var="c">
                            <li><a href="#/procedures/${c.idcourrierProcedure}">
                                    <span class="mif-mail-read icon"></span>
                                    <span class="title">${c.ref}</span>
                                    <span class="counter">${c.courrierType.nom}</span>
                                </a>
                            </li>
                        </c:forEach>
                    </ul>
                ...
                <div class="cell colspan8" style="height: 100%; padding-top: 20px;">
                    <div class="">
                        <div class="">
                            <div class="step">
                                <div class="step-content">
                                    <div class="ribbed-grayLighter padding20" style="padding-right: 20px; border-bottom: 1px solid #1ba1e2;">
                                        <div class="row cells6">
                                            <span class="fg-blue" onclick="window.location.href='courrier#/procedures'" style="cursor: pointer;">Procédure</span>
                                            <h3 id="titre_liste">${procedure.nom}</h3>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row cells6">
                                            <table id="example_table" class="dataTable border bordered" style="margin-bottom: 10px;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <c:forEach items="${procedure.courrierProcedureTaches}" var="tp">
                                                        <tr class="${tp.employe.idemploye==sessionScope.utilisateur.employe.idemploye ? "ribbed-grayLighter":""}">
                                                            <td>${tp.ordre}</td>
                                                            <td>${tp.ref}</td>
                                                            <td><a href="courrier#/procedures/">${tp.libelle}</a></td>
                                                            <td>
                                                                ${tp.employe.noms} ${tp.employe.prenoms}<br>
                                                                <small>${tp.employe.poste.libelle}</small>
                                                            </td>
                                                            <td><a href="courrier#/procedures/">${tp.typeApprobation}</a></td>
                                                            <td>${tp.duree} jour(s)</td>
                                                            <c:set var="duree" scope="session" value="${duree+tp.duree}"/>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                                <tfoot >
