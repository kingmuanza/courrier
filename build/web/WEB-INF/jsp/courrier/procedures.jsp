            ...
            <div class="row cells12" style="height: 100%">
                ...
                <div class="cell colspan8" style="height: 100%">
                    <div class="row cells6">
                        <h3 id="titre_liste">Procédures</h3>
                        ...
                        <table id="example_table" class="dataTable border bordered" style="margin-bottom: 10px;">
                            ...
                            <tbody>
                                <c:forEach items="${procedures}" var="p">
                                    <tr>
                                        <td><a href="courrier#/procedures/${p.idcourrierProcedure}" class="">${p.ref}</a></td>
                                        <td>${p.nom}</td>
                                        <td>${p.courrierType.nom}</td>
                                        <td>
                                            ${fn:length(p.courrierProcedureTaches)}
                                        </td>
                                        <c:set var="duree" scope="session" value="${0}"/>
                                        <td>
                                            <c:forEach items="${p.courrierProcedureTaches}" var="tp">
