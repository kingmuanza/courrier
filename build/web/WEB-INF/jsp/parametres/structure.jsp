            ...
            <div class="row cells6" style="height: 100%">
                <div class="cell" id="cell-sidebar" style="background-image: url('img/keama_background.png'); height: 100%;">
                    ...
                    <script>
                        ...
                        function showDialog(id, idstructure, nom, sigle, idparent, idsite) {
                            var dialog = $(id).data('dialog');
                            dialog.open();
                            $("#formulaireStructure input[name=id]").val(idstructure);
                            $("#formulaireStructure input[name=nom]").val(nom);
                            $("#formulaireStructure input[name=sigle]").val(sigle);
                            $("#formulaireStructure select[name=parent]").val(idparent);
                            $("#formulaireStructure select[name=site]").val(idsite);
                                        ...
                                        <div class="listview set-border list-type-listing " data-role="listview">
                                            <div class="padding20">
                                                <small class="place-right">
                                                    <a style="cursor: pointer;" class="toolbar-button" data-role="hint" data-hint="Ajouter une structure" onclick="showDialog('#dialog_site')" >
                                                        <h5 class="mif-plus "></h5>
                                                    </a>
                                                </small>
                                                <h2 class=""><span class="fg-blue">Structures</span></h2>
                                                ...
                                                <table id="example_table" class="dataTable border bordered" style="margin-bottom: 10px; margin-top: 10px;">
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${structures}" varStatus="boucle" var="structure">
                                                            <tr data-tt-id="${structure.idstructure}" data-tt-parent-id="${structure.structure.idstructure}">
                                                                <td>${boucle.count}</td>
                                                                <td style="white-space: nowrap;">${structure.sigle}</td>
                                                                <td><a onclick="showDialog('#dialog_site', '${structure.idstructure}', '${structure.nom}', '${structure.sigle}', '${structure.structure.idstructure}', '${structure.site.idsite}');" style="cursor: pointer;">${structure.nom}</a></td>
                                                                <td>${structure.site.nom} ${structure.site.estSiege ? "(Siège)":""}</td>
                                                                <td>
                                                                    <a onclick="supprimer('${structure.idstructure}');" style="cursor: pointer;" data-role="hint" data-hint="Supprimer">Supprimer </a>
                                                                </td>
                                                            </tr>
                ...
                <div id="menu_droit" class="cell bg-grayLighter" style="padding: 20px;">
                    ...
                    <div class="row align-center" >
                        <button class="image-button bg-blue fg-white" onclick="window.open('organigrammeStructure')">
                            Organigramme
