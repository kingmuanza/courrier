            ...
            <div class="row cells12" style="height: 100%">
                ...
                <div class="cell colspan7" style="height: 100%">
                    <div class="row cells6">
                        <h1 id="titre_liste">Toutes les informations<span class="icon mif-menu fg-blue place-right" style="cursor: pointer;" onclick="window.location.href = 'information#/tous'"></span></h1>
                        <hr>
                    </div>
                    <div class="row cells6">
                                ...
                                <c:forEach items="${informations}" var="i">
                                    <div class="step">
                                        <div class="step-content">
                                            <fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${i.dateEnregistrement}" var="dateDebut"/>
                                            <p class="text-small">Crée le : ${dateDebut}</p>
                                            <div class="clear-float">
                                                ...
                                                <div class="place-left">
                                                    <h4 class="no-wrap"> ${i.titre}</h4>
                                                    <h5>Par : ${i.employe.noms} ${i.employe.prenoms}</h5>
                                            ...
                                            <div class="listview list-type-listing set-border padding10" data-role="listview" id="lv1">
                                                <c:forEach items="${i.informationGeneraleEmployes}" var="re">
                                                    <div class="list">
                                            ...
                                            <div class="row">
                                                ...
                                                <ul class="">
                                                    <c:forEach items="${reunion.reunionRapports}" var="rr">
                                                        <li><a href="Rapports/${rr.chemin}">${rr.chemin}</a></li>
                                                        </c:forEach>
                                                </ul>
                                            </div>
                                        </div>
