            ...
            <div class="row cells12" style="height: 100%">
                ...
                <div class="cell colspan9" style="height: 100%; padding-right: 20px;">
                    <div class="row cells6">
                        <h3 id="titre_liste">
                            Réunions à venir
                            <c:if test="${!empty reunions}">
                                <span 
                                    class="icon mif-folder-open muanza_fg_violet place-right" 
                                    style="cursor: pointer;" 
                                    onclick="window.location.href = 'reunion#/avenir/light'">
