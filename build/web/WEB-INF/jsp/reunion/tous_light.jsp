            ...
            <div class="row cells12" style="height: 100%">
                ...
                <div class="cell colspan7" style="height: 100%">
                    <div class="row cells6">
                        <h1 id="titre_liste">Toutes les réunions<span class="icon mif-menu fg-blue place-right" style="cursor: pointer;" onclick="window.location.href = 'reunion#/tous'"></span></h1>
                        <hr>
                    </div>
                    <div class="row cells6">
